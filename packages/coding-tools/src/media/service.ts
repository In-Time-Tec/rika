...
import { Output, type AnalysisInput, type MediaKind } from "./contract"
import { MediaMissingError, MediaOversizedError, UnsupportedMediaError } from "./errors"
import { maxOutputBytes } from "../runtime/result/value"
...
export class MediaAnalyzer extends Context.Service<MediaAnalyzer, AnalyzerInterface>()(
  "@rika/coding-tools/media/service/MediaAnalyzer",
) {}
