...
/**
 * Shaped like Generalist's HostModuleNotFound so an unknown server or tool reaches the cell as tagged
...
): HostBindings.Module<McpRuntime.McpRuntimeService | Requirements> => {
