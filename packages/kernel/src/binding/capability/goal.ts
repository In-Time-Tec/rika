...
export const operations: ReadonlyArray<HostBindings.AnyOperation<GoalService | Requirements>> = [
  operation({
    name: "get",
    input: Empty,
    output: Current,
...
export const module: HostBindings.Module<GoalService | Requirements> = { name, operations }
