...
export const operations: ReadonlyArray<HostBindings.AnyOperation<ArtifactStore | Requirements>> = [
  operation({
    name: "put",
    input: PutInput,
    output: Stored,
...
export const module: HostBindings.Module<ArtifactStore | Requirements> = { name, operations }
