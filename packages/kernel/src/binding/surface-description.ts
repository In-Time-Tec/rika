...
export const surfaceOf = (modules: ReadonlyArray<HostBindings.Module<BindingRequirements>>): string =>
  modules
    .map((module) => {
...
export interface CellInstructionFacts {
  readonly modules: ReadonlyArray<HostBindings.Module<BindingRequirements>>
