...
export interface FileCredentialAuth extends GeneralistTransportAuth {
...
): Effect.Effect<FileCredentialAuth, HostedCredentialError, FileSystem.FileSystem | Path.Path> => {
  const program: Effect.Effect<FileCredentialAuth, HostedCredentialError, FileSystem.FileSystem | Path.Path> = Effect.gen(function* () {
