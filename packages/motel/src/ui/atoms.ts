...
const initialTheme = (() => {
	const value = envString("MOTEL_TUI_THEME")
	return value === "rika" || value === "tokyo-night" || value === "catppuccin" || value === "motel-default"
		? value
		: readLastTheme()
})()
...
export const selectedThemeAtom = Atom.make<ThemeName>(initialTheme).pipe(Atom.keepAlive)
