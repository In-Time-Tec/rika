...
import { credentialAdditionalAuthenticatedData, credentialKmsEncryptionContext } from "./credential-aad"
import { CredentialCipher, type CredentialCipherFailure, type EncryptedCredentialBytes } from "./credential-cipher"
import {
  CredentialAuthTag,
...
export class CredentialVault extends Context.Service<CredentialVault, CredentialVaultShape>()(
  "@rika/credential-vault/credential-vault/CredentialVault",
) {}
