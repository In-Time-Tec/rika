...
export class MediaAnalyzer extends Context.Service<MediaAnalyzer, AnalyzerInterface>()(
  "@rika/tools/media/media-view-service/MediaAnalyzer",
) {}
...
export class Service extends Context.Service<Service, Interface>()("@rika/tools/media/media-view-service/Service") {}
