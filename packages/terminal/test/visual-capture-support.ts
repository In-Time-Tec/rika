  ...
  return [
    ...
    [
      "meter-muncher-open",
      {
        ...
        contextUsage: { _tag: "Available", inputCacheRead: 0, inputTokens: 208_294, contextWindow: 1_050_000, reserveTokens: 128_000 },
      },
      80,
      24,
    ],
    ...
    [
      "meter-flash",
      {
        ...
        contextUsage: { _tag: "Available", inputCacheRead: 0, inputTokens: 700_000, contextWindow: 1_050_000, reserveTokens: 128_000 },
      },
      80,
      24,
    ],
    ...
    [
      "compact-context-details",
      {
        ...
        currentThreadId: "context-thread",
        contextDetailsOpen: true,
        contextUsage: { _tag: "Available", inputCacheRead: 0, inputTokens: 56_120, contextWindow: 372_000, reserveTokens: 128_000 },
        usageCost: { _tag: "Available", usd: 1.25, unpricedAttempts: 0, includedAttempts: 0 },
        usageTime: { _tag: "Available", accumulatedMillis: 103_000 },
      },
      24,
