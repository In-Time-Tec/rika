...
const longDiff = [
  ...
  "+Bearer authentication accepts a dynamic BearerTokens source or bearerTokens(Redacted.make(token)) without Generalist minting or persisting any secret material.",
  "",
].join("\n")
