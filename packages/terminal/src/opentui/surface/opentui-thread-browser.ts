...
import { selectedThreadMetadata } from "../../state/model/terminal-thread-navigation"
import { initial, type Model } from "../../state/model/terminal-state"
import { toOpenColor } from "../rendering/terminal-text-adapter"
import { threadSwitcherListContent, threadSwitcherListWidth } from "./opentui-overlay-content"
