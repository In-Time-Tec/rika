...
import { makeResolver } from "../src/route"
import { laneExecutionRoute, makeLaneModels } from "../src/test-harness"
import { configure, remoteCell } from "./test-adapters"
  ...
  () =>
    Effect.scoped(
      Effect.gen(function* () {
        ...
        const filename = `/tmp/rika-tenetkit-steering-conformance-${yield* Random.nextInt}.db`
