...
export class Service extends Context.Service<Service, Interface>()("@rika/execution/cell-context/Service") {}
 ...
 */
const bindImpl = (registry: HostBindingRegistry.Interface, calls: Interface): HostBindingRegistry.Interface => ({
