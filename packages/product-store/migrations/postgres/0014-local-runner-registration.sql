CREATE TABLE rika_hosted_local_runner_registrations (
...
CREATE INDEX rika_hosted_local_runner_registration_user
  ON rika_hosted_local_runner_registrations (user_id, device_id, checkout_fingerprint);
