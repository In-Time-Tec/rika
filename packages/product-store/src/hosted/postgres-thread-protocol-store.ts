...
import { and, asc, desc, eq, gt, gte, isNull, lt, lte, max, min, or, sql, type SQLWrapper } from "drizzle-orm"
...
const make = Effect.gen(function* (): Effect.fn.Return<ThreadProtocolStoreService, never, PgClient.PgClient> {
  ...
  const writeEvents = Effect.fn("PostgresThreadProtocolStore.writeEvents")(function* (
