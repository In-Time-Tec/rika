...
import { rikaHostedCheckpoints, rikaHostedExecutorAssignments, rikaHostedThreads } from "../database/schema/product"
      ...
      executor
        ...
        .where(
          or(
            ...
            input.assignmentId === undefined ? undefined : eq(rikaHostedExecutorAssignments.id, input.assignmentId),
          ),
        )
