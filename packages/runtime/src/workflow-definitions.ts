...
const delivery: DynamicDefinition = {
  ...
  operations: [
    ...
    child("delivery:investigate", "Task", "Investigate the requested change and report grounded findings."),
...
const research: DynamicDefinition = {
  ...
  operations: [
    ...
    },
    {
      ...
      kind: "parallel",
      fanOutKey: "research",
      operations: ["research:investigate", "research:librarian"],
      maxConcurrency: 2,
    },
    child("research:investigate", "Task", "Investigate the repository evidence relevant to the question."),
    child("research:librarian", "Librarian", "Research authoritative documentation and citations for the question."),
    {
      ...
      members: ["research:investigate", "research:librarian"],
      policy: { _tag: "all" },
    },
