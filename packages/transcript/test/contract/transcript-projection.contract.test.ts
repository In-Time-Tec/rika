...
import { applyEvent as directApplyEvent } from "../../src/projection/transcript-projection"
...
import { applyEvent as exportedApplyEvent } from "@rika/transcript/transcript-projection"
...
describe("transcript export contracts", () => {
  ...
  it("uses one projection function identity for the public and source paths", () => {
    expect(exportedApplyEvent).toBe(directApplyEvent)
  })
})
