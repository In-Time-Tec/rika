...
import { makeWithSdk, type E2BSdk } from "../src/e2b-provider"
...
const request = {
  ...
  secrets: { RIKA_EXECUTOR_BOOTSTRAP_TOKEN: Redacted.make("bootstrap-secret") },
} as const
