...
const expected: Record<string, ReadonlyArray<string>> = {
  ...
  "@rika/product": [
    ...
    "hosted-authority-repository",
    "hosted-client-control-plane-protocol",
    "hosted-executor-control-plane-protocol",
  ...
  "@rika/product-store": [
    "memory-hosted-authority-repository",
    "postgres-hosted-authority-layer",
    "postgres-hosted-authority-repository",
