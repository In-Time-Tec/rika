...
export const ClientToControlPlane = Schema.Union([
...
export type ClientToControlPlane = typeof ClientToControlPlane.Type

export const ControlPlaneToClient = Schema.Union([
...
export type ControlPlaneToClient = typeof ControlPlaneToClient.Type
