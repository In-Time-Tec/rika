...
import type { AuthorizationAction } from "./identity/authorization"
import type { PromptAdmissionStatus } from "./protocol/client"
import {
...
export class HostedStore extends Context.Service<HostedStore, StoreService>()(
  "@rika/product/hosted/store/HostedStore",
) {}
