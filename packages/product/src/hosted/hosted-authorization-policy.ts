...
import { BetterAuthMemberId, ExecutorKind, GrantRole } from "./hosted-authority-model"
...
export interface AuthorizationPolicyInterface {
  readonly authorize: (
    action: AuthorizationAction,
...
export class AuthorizationPolicy extends Context.Service<AuthorizationPolicy, AuthorizationPolicyInterface>()(
  "@rika/product/hosted/hosted-authorization-policy/AuthorizationPolicy",
) {
