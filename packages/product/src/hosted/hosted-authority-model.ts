...
export const ExecutorStatus = Schema.Literals(["online", "draining", "offline"])
...
export const ExecutorInstance = Schema.Struct({
...
export type ExecutorInstance = typeof ExecutorInstance.Type

export const ExecutorAssignmentLease = Schema.Struct({
  organizationId: OrganizationId,
  threadId: ThreadId,
...
export type ExecutorAssignmentLease = typeof ExecutorAssignmentLease.Type
