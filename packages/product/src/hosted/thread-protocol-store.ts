...
import type { HostedThreadSnapshot } from "./protocol/client-protocol"
import type {
  ActorAttribution,
  BetterAuthUserId,
  ClientId,
...
import type { StoreError } from "./hosted-store"
...
export class ThreadProtocolStore extends Context.Service<ThreadProtocolStore, ThreadProtocolStoreService>()(
  "@rika/product/hosted/thread-protocol-store/ThreadProtocolStore",
) {}
