...
export const run = Effect.fn("ThreadOperation.run")(function* (input: Extract<Input, { readonly _tag: "Thread" }>, dependencies: Dependencies) {
        ...
        Effect.gen(function* () {
          ...
          return yield* Effect.gen(function* () {
            ...
            for (const sourceTurn of copiedSourceTurns) {
              ...
              const copied = yield* turns.copy({ ...sourceTurn, id, threadId: fork.id }, dependencies.pendingTurnCapacity)
