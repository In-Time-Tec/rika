...
import type { ExactLookup, Options } from "./contract"
import { LocalPathError } from "./error"
 ...
 *
 * Reachability is deliberately not decided here. The Executor runs with the Workspace owner's authority,
 * and its shell can already reach any path this resolver could refuse, so refusing here
