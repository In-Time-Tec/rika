...
import type { CreateInput } from "./turn-contract"
import type { PageOptions, PageResult } from "./turn-pagination"
import type { QueuedSteeringAdmissionPreparation, SteeringAdmission } from "./turn-steering"
import type { QueueClaim, QueueClaimFinish, QueueItemChange, QueueSnapshot, Submission } from "./turn-queue"

export type { QueueSnapshot } from "./turn-queue"
...
export interface Interface {
  ...
  readonly completeSteeringAdmission: (
    ...
    target: import("@rika/product/execution-gateway").ExecutionLink,
    receipt: import("@rika/product/execution-gateway").SteeringReceipt,
  ) => Effect.Effect<import("./turn-queue").QueueItemChange | undefined, RepositoryError>
