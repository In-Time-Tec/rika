...
export class JwtCrypto extends Context.Service<JwtCrypto, JwtCryptoService>()("@rika/github-app/auth/jwt/JwtCrypto") {}
...
export class AppJwt extends Context.Service<AppJwt, AppJwtService>()("@rika/github-app/auth/jwt/AppJwt") {}
