...
Use isolated `HOME`, product SQLite, Baton SQLite, and `RIKA_TEST_MODEL_SCRIPT` for deterministic agentic workflows. Never treat text echoed in the composer as proof of model completion; wait for a unique scripted response or tool result.
