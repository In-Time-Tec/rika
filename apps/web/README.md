...
Set `PORT=3000`, `NODE_ENV=production`, `API_DOMAIN` to the API service's private Railway domain, and `API_PORT=3000`. The service needs no PostgreSQL, Better Auth, GitHub, Resend, or Box credentials.
