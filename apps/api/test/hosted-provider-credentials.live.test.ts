...
import { Context, Effect, Layer, Option, Random, Redacted, Schema } from "effect"
import { Pool } from "pg"
import { HostedModelRegistry, layer as modelRegistryLayer } from "../src/hosted-model-registry"
import {
  HostedProviderCredentialError,
  HostedProviderCredentials,
  layer as credentialsLayer,
  storeLayer,
} from "../src/hosted-provider-credentials"
...
it.effect.skipIf(databaseUrl === undefined)(
  "encrypts, rotates, revokes, and resolves owner-scoped provider credentials",
  () =>
    Effect.scoped(
      Effect.gen(function* () {
