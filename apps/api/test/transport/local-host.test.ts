...
import { makeApiV2LocalHost, serveApiV2LocalHost } from "../../src/transport/local-host"
...
import type { RuntimeGateway } from "../../src/transport/runtime-gateway"
import { threadContext, unavailableWorkspace } from "../fixtures/context"
...
const workspace = unavailableWorkspace(binding.workspaceBinding)
const context = () =>
  threadContext(binding.workspaceBinding, partition.rootSessionId, model).pipe(
