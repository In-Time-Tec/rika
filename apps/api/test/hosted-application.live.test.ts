        ...
        const context = yield* Layer.buildWithScope(
          hostedApplicationLayer({
            ...
            executor: {
              ...
              checkpointBucket: "rika-test",
              checkpointRegion: "us-east-1",
              checkpointEndpoint: undefined,
              checkpointKey: Redacted.make("AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA="),
              setupCache: false,
            },
