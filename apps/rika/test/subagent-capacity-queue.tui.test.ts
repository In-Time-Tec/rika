      ...
      Effect.gen(function* () {
        const app = yield* TuiApp.tuiApp({
          ...
          lanes: [
            ...
            { profile: "Task", steps: [model.text("FIRST_DONE", 3_000)] },
            { profile: "Oracle", steps: [model.text("SECOND_DONE", 3_000)] },
            { profile: "Review", steps: [model.text("THIRD_DONE", 3_000)] },
            { profile: "Surgeon", steps: [model.text("FOURTH_DONE", 3_000)] },
