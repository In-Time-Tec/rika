...
const runnerBindingName = matching(/^[a-z][a-z0-9._-]{0,63}$/, 64)
...
const annotationSchemas = {
  ...
  "rika.binding.call.id": runnerOperationKey,
  "rika.binding.id": hostedCorrelationId,
  "rika.binding.module": runnerBindingName,
  "rika.binding.operation": runnerBindingName,
  "rika.binding.pending": boundedNumber,
  "rika.cell.id": hostedCorrelationId,
  "rika.host.status": oneOf("started", "returned", "failed"),
  "rika.kernel.epoch": boundedNumber,
  "rika.kernel.restart_reason": oneOf("requested", "killed", "crashed", "profile-changed"),
  "rika.silent.millis": boundedNumber,
  "rika.state_lost.reason": oneOf("function", "class", "module", "live-handle", "oversized", "unserializable"),
