...
import type { Overlay as ModelPreviewOverlay } from "../../controller/model-preview"
import * as BunServices from "@effect/platform-bun/BunServices"
import { Deferred, Effect, Fiber, SubscriptionRef } from "effect"
import type { TuiLifecycle } from "../lifecycle/interrupt"
import type { InteractiveTuiOptions } from "../lifecycle/loop"

export interface InteractiveLoop {
  model: Model
  threadView: ThreadView.ThreadViewAccumulator | undefined
