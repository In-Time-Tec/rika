...
/**
 * Packaged Electron windows load renderer HTML via the privileged `rika-renderer://`
...
describe("electron vite publicDir", () => {
  test("configured publicDir resolves to a directory with rika-theme-preload.js", async () => {
    ...
    expect(existsSync(join(resolved, "rika-theme-preload.js"))).toBe(true)
  })
})
