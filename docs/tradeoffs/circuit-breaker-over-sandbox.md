...
**Gain:** cells work on any path the user can reach, so sibling repositories, dotfiles, absolute paths, and miscased paths stop failing. A short hardcoded refusal list still stops the few mistakes nobody recovers from.
