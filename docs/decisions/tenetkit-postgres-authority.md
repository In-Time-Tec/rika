# TenetKit runs in the control plane

Rika composes TenetKit's released PostgreSQL runtime and SQL worker in the Railway control plane. TenetKit-owned PostgreSQL tables remain the only authority for Runs, model turns, journals, continuations, steering, approvals, cancellation, children, and Run events.
