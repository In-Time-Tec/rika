...
The broad many-tool route, QuickJS Code Mode, and `@rika/javascript-sandbox` are deleted at cutover. The cell and two Baton-native child-control tools are the one production path.
