...
The kernel namespace is working memory. Baton operations, events, Session entries, and children remain the only durable truth, and Rika describes kernel variables that way to the model rather than implying they survive.
