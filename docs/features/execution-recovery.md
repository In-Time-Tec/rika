...
Following stops at a Relay terminal event. Missing or interrupted transport never invents completion, and stale local terminal updates cannot replace a known terminal result. A disposable projection or Thread summary may be rebuilt from Relay after loss or mismatch.
