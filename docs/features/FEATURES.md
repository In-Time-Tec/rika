...
| Thread mention              | `@@`                        | Yes     | Included                                 | implemented       | 05, 09, 11 | Typed mention parsing and Run prompt-expansion tests                               |
...
| Command palette                  | `Ctrl+O`          | Yes              | Included       | implemented       | 11, 13 | Palette and view-state tests                                                                                                              |
| Thread sidebar                   | `Alt+S`           | Partial          | Included       | implemented       | 05, 11 | Frozen native sidebar character-frame and screenshot baseline                                                                             |
...
| Multiple background threads      | Yes               | Partial          | Included       | framework-blocked | 05, 07 | Relay proof                                                                                                                               |
| Sidebar keyboard navigation      | Yes               | Partial          | Included       | planned           | 11     | Pending                                                                                                                                   |
...
| Dedicated compaction route      | Yes              | Yes                        | Included                             | planned      | 04, 09 | Pending                                          |
...
| Narrow child model/budget   | Yes                            | Yes        | Included              | framework-blocked | 07         | Relay proof                                                                              |
...
| Feature                      | Amp July 2026                | Rika v1         | Rika v2                        | Status            | Spec   | Evidence                                                                    |
| ---------------------------- | ---------------------------- | --------------- | ------------------------------ | ----------------- | ------ | --------------------------------------------------------------------------- |
| Local logs                   | Yes                          | Yes             | Included                       | planned           | 16     | Pending                                                                     |
| Configurable log level/file  | Yes                          | Yes             | Included                       | planned           | 16     | Pending                                                                     |
...
| Local diagnostic export      | Support upload in Amp        | Partial         | Included                       | planned           | 16     | Pending                                                                     |
| OpenTelemetry opt-in         | Internal/unknown             | Yes             | Included                       | planned           | 16     | Pending                                                                     |
...
| Scripted fake model            | Internal unknown       | Fake provider tests                   | `@batonfx/test` harness                   | implemented | 15         | Real Baton TestModel and Relay SQLite cover text, reasoning, tools, malformed calls, permissions, steering, retry, budgets, cancellation, forced compaction, backend reopen, replay, and opaque terminal failure projection |
...
| Live Vibe proxy smoke          | N/A                    | Local provider tests                  | Opt-in Effect Config suite                | planned     | 04, 15     | Pending                                                                                                                                                                                                                     |
