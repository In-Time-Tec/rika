...
| File tree sidebar                | `Alt+T`           | Yes              | Included                          | verified     | 11     | 10,000-file native latency test and installed Pilotty input check                                                                         |
...
| Changed-files sidebar            | Yes               | Partial          | Included                          | verified     | 11     | Virtual row window, stable refresh snapshots, 10,000-file native latency test, scrolling, clicking, and resize coverage                   |
