...
Agents use `rika.media.attach` for images, PDFs, audio, and video up to 25 MiB anywhere the user running Rika can read; media outside the Workspace is sent to the configured analyzer like any other. PNG, JPEG, GIF, and WebP return image metadata; PDF, MP3, Ogg, WAV, and MP4 use the configured media analyzer and return bounded text.
